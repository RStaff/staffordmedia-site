    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/82 backdrop-blur-xl">
      ...
      >
        ...
        <nav className="flex items-center gap-3 text-sm md:gap-6">
          ...
          <details className="relative text-white/80">
            ...
            <div className="absolute right-0 top-8 z-10 grid min-w-44 gap-1 rounded-xl border border-white/10 bg-slate-950 p-2 shadow-2xl">
              <Link href="/careeros" className="rounded-lg px-3 py-2 transition hover:bg-white/10 hover:text-white">CareerOS</Link>
              <Link href="/shopifixer" className="rounded-lg px-3 py-2 transition hover:bg-white/10 hover:text-white">ShopiFixer</Link>
              <Link href="/abando" className="rounded-lg px-3 py-2 transition hover:bg-white/10 hover:text-white">Abando.ai</Link>
            </div>
          </details>
