    ...
    {preview ? (
      <section aria-labelledby="opportunity-heading" className="mt-10 grid gap-8">
        <div>
          ...
          <h2 id="opportunity-heading" className="mt-3 text-3xl font-bold text-white">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button type="button" onClick={() => { setPreview(null); setHandoffError(false); }} className="smc-button smc-button-secondary">
            Adjust My Answers
          </button>
        </div>
      </section>
