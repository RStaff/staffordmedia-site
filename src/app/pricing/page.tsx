...
export default async function PricingPage({ searchParams }: PageProps) {
  ...
  <p className="mt-4 max-w-3xl text-base leading-8 text-slate-300">
    Based on your audit, we implement the clearest issue suppressing revenue in your store.
    This is a focused, done-for-you fix — not a redesign, not a retainer.
  </p>
  ...
  <div className="mt-6 inline-flex items-center gap-3 rounded-xl border border-white/12 bg-slate-950 px-4 py-2 text-sm text-slate-200">
    <img src="/brand/shopify_partner-logo-white.png" alt="Official Shopify Partner" className="h-5 w-auto" />
